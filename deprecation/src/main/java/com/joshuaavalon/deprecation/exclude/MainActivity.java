...
import com.joshuaavalon.wsdeckeditor.exclude.fragment.AboutFragment;
import com.joshuaavalon.wsdeckeditor.exclude.fragment.DeckListFragment;
import com.joshuaavalon.wsdeckeditor.exclude.fragment.ExpansionFragment;
import com.joshuaavalon.wsdeckeditor.exclude.fragment.SearchFragment;
import com.joshuaavalon.wsdeckeditor.exclude.fragment.SettingFragment;
import com.joshuaavalon.wsdeckeditor.exclude.fragment.UpdateFragment;
...
public class MainActivity extends AppCompatActivity implements SnackBarSupport,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (PreferenceRepository.getFirstTime(this)) {
            ...
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.fragment, new UpdateFragment(), null)
