...
public class SearchFragment2 extends BaseFragment {
    ...
    @Nullable
    public static SearchFragment2 newInstance(@Nullable final CardRepository.Filter filter) {
        final SearchFragment2 fragment = new SearchFragment2();
        if (filter != null) {
            final Bundle args = new Bundle();
            args.putParcelable(SearchFragment2.FILTER_KEY, filter);
